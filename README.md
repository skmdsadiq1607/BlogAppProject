...
### Frontend
    Dynamic, Responsive Usr Interfaces(UI== webpage---->Browser)
                             HTML
                CSS(styles & responsiveness), Bootstrap, Tailwind CSS
            JavaScript(behavior & interactivity)[ReactJS, Angular, VueJS, NextJS]
